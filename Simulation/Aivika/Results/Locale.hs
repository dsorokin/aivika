...
russianResultLocalisation EstimatedQueueArrivalRateId = "оценка долгосрочной средней скорости прибытия заявок"
...
englishResultLocalisation EstimatedQueueArrivalRateId = "the estimated long-term average effective arrival rate"
