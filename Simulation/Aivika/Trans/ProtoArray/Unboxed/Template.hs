...
-- |
-- Module     : Simulation.Aivika.Trans.ProtoArray.Unboxed.Template
...
--
module Simulation.Aivika.Trans.ProtoArray.Unboxed.Template where
...
instance ProtoArraying m a => ProtoArraying (TemplateComp m) a where
